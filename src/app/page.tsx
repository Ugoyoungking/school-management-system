    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-14 flex items-center bg-primary text-primary-foreground">
        <Link href="#" className="flex items-center justify-center" prefetch={false}>
          ...
          <span className="ml-2 font-semibold text-lg">Glide & Reign Int'l</span>
        </Link>
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none text-primary">
                    Manage Your School with Effortless Grace
                  </h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Glide and Reign International School's management portal. Streamline student and teacher management, track attendance, analyze grades, and much more.
                  </p>
                </div>
